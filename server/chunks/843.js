...
const WalletListItem = ({ handleClick , tabIndex , wallet  })=>{
    return(/*#__PURE__*/ external_react_default().createElement("li", null, /*#__PURE__*/ external_react_default().createElement(Button_Button, {
        onClick: handleClick,
        endIcon: /*#__PURE__*/ external_react_default().createElement(WalletIcon_WalletIcon, {
            wallet: wallet
        }),
        tabIndex: tabIndex
    }, wallet.name)));
...
const WalletModal = ({ className ='' , logo , featuredWallets =3 , container ='body' ,  })=>{
    ...
    const { 0: fadeIn , 1: setFadeIn  } = (0,external_react_.useState)(false);
    const { 0: portal , 1: setPortal  } = (0,external_react_.useState)(null);
    const { 0: featured , 1: more  } = (0,external_react_.useMemo)(()=>[
    ...
    const handleCollapseClick = (0,external_react_.useCallback)(()=>setExpanded(!expanded)
    , [
        setExpanded,
        expanded
    ]);
    ...
    (0,external_react_.useLayoutEffect)(()=>setPortal(document.querySelector(container))
    , [
        setPortal,
        container
    ]);
...
const WalletModalProvider = (_a)=>{
    ...
    }, children, visible && /*#__PURE__*/ external_react_default().createElement(WalletModal, Object.assign({
    }, props))));
...
const WalletMultiButton = (_a)=>{
    ...
    if (!wallet) return(/*#__PURE__*/ external_react_default().createElement(WalletModalButton, Object.assign({
    }, props), children));
    if (!base58) return(/*#__PURE__*/ external_react_default().createElement(WalletConnectButton, Object.assign({
    }, props), children));
    return(/*#__PURE__*/ external_react_default().createElement("div", {
