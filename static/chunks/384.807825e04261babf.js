...
var WalletError = /*#__PURE__*/ function(Error) {
    ...
    function WalletError(message, error) {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletError).call(this, message));
        _this.error = error;
        return _this;
    }
    return WalletError;
...
var WalletNotFoundError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletNotFoundError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletNotFoundError).apply(this, arguments));
...
var WalletNotInstalledError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletNotInstalledError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletNotInstalledError).apply(this, arguments));
...
var WalletNotReadyError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletNotReadyError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletNotReadyError).apply(this, arguments));
...
var WalletConnectionError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletConnectionError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletConnectionError).apply(this, arguments));
...
var WalletDisconnectedError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletDisconnectedError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletDisconnectedError).apply(this, arguments));
...
var WalletDisconnectionError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletDisconnectionError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletDisconnectionError).apply(this, arguments));
...
var WalletAccountError = /*#__PURE__*/ (/* unused pure expression or super */ null && (function(WalletError) {
    ...
    function WalletAccountError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletAccountError).apply(this, arguments));
...
var WalletPublicKeyError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletPublicKeyError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletPublicKeyError).apply(this, arguments));
...
var WalletKeypairError = /*#__PURE__*/ (/* unused pure expression or super */ null && (function(WalletError) {
    ...
    function WalletKeypairError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletKeypairError).apply(this, arguments));
...
var WalletNotConnectedError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletNotConnectedError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletNotConnectedError).apply(this, arguments));
...
var WalletSendTransactionError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletSendTransactionError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletSendTransactionError).apply(this, arguments));
...
var WalletSignMessageError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletSignMessageError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletSignMessageError).apply(this, arguments));
...
var WalletSignTransactionError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletSignTransactionError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletSignTransactionError).apply(this, arguments));
...
var WalletTimeoutError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletTimeoutError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletTimeoutError).apply(this, arguments));
...
var WalletWindowBlockedError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletWindowBlockedError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletWindowBlockedError).apply(this, arguments));
...
var WalletWindowClosedError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletWindowClosedError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletWindowClosedError).apply(this, arguments));
...
/* harmony import */ var _home_adrou_Desktop_seacrg_engine_create_dapp_solana_nextjs_node_modules_next_node_modules_regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8520);
/* harmony import */ var _home_adrou_Desktop_seacrg_engine_create_dapp_solana_nextjs_node_modules_next_node_modules_regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_home_adrou_Desktop_seacrg_engine_create_dapp_solana_nextjs_node_modules_next_node_modules_regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0__);
...
function poll(callback, interval, count) {
    if (count > 0) {
        var _this = this;
        setTimeout(function() {
            return __awaiter(_this, void 0, void 0, _home_adrou_Desktop_seacrg_engine_create_dapp_solana_nextjs_node_modules_next_node_modules_regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
                var done;
                return _home_adrou_Desktop_seacrg_engine_create_dapp_solana_nextjs_node_modules_next_node_modules_regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_ctx) {
...
var BaseSignerWalletAdapter = /*#__PURE__*/ function(BaseWalletAdapter) {
    "use strict";
    _inherits(BaseSignerWalletAdapter, BaseWalletAdapter);
    function BaseSignerWalletAdapter() {
        _classCallCheck(this, BaseSignerWalletAdapter);
        return _possibleConstructorReturn(this, _getPrototypeOf(BaseSignerWalletAdapter).apply(this, arguments));
    }
    _createClass(BaseSignerWalletAdapter, [
        {
            key: "sendTransaction",
            value: function sendTransaction(transaction, connection, param) {
                var options = param === void 0 ? {
                } : param;
                return __awaiter(this, void 0, void 0, _home_adrou_Desktop_seacrg_engine_create_dapp_solana_nextjs_node_modules_next_node_modules_regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
                    var _transaction, signers, sendOptions, rawTransaction;
                    return _home_adrou_Desktop_seacrg_engine_create_dapp_solana_nextjs_node_modules_next_node_modules_regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            case 0:
                                _ctx.prev = 0;
...
var BaseMessageSignerWalletAdapter = /*#__PURE__*/ function(BaseSignerWalletAdapter) {
    ...
    function BaseMessageSignerWalletAdapter() {
        ...
        return _possibleConstructorReturn(this, _getPrototypeOf(BaseMessageSignerWalletAdapter).apply(this, arguments));
    }
...
var WalletNotSelectedError = /*#__PURE__*/ function(WalletError) {
    ...
    function WalletNotSelectedError() {
        ...
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(WalletNotSelectedError).apply(this, arguments));
...
var PhantomWalletAdapter = /*#__PURE__*/ function(BaseMessageSignerWalletAdapter) {
    "use strict";
    _inherits(PhantomWalletAdapter, BaseMessageSignerWalletAdapter);
    function PhantomWalletAdapter(param) {
        var config = param === void 0 ? {
        } : param;
        _classCallCheck(this, PhantomWalletAdapter);
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(PhantomWalletAdapter).call(this));
...
var getPhantomWallet = function(param) {
    var config = param === void 0 ? {
    } : param;
    return {
...
var SolflareWalletAdapter = /*#__PURE__*/ function(BaseSignerWalletAdapter) {
    "use strict";
    _inherits(SolflareWalletAdapter, BaseSignerWalletAdapter);
    function SolflareWalletAdapter(param) {
        var config = param === void 0 ? {
        } : param;
        _classCallCheck(this, SolflareWalletAdapter);
        var _this;
        _this = _possibleConstructorReturn(this, _getPrototypeOf(SolflareWalletAdapter).call(this));
        _this._disconnected = function() {
            var wallet = _this._wallet;
            if (wallet) {
                wallet.off('disconnect', _this._disconnected);
...
(signer/* BaseSignerWalletAdapter */.s);
...
var getSolflareWallet = function(param) {
    var config = param === void 0 ? {
    } : param;
    return {
...
var getSolletWallet = function(param) {
    var _a = param === void 0 ? {
    } : param;
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "w": function() { return /* binding */ WalletName1; }
/* harmony export */ });
var WalletName1;
