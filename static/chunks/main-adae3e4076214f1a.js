...
var _runtimeJs = _interopRequireDefault(__webpack_require__(8520));
...
var PageLoader = /*#__PURE__*/ function() {
    function PageLoader(buildId, assetPrefix) {
        ...
        /** @type {Promise<Set<string>>} */ this.promisedSsgManifest = new Promise(function(resolve) {
    ...
    return {
        ...
        loadRoute: function(route, prefetch) {
            ...
            return withFuture(route, routes, function() {
                var _this1 = _this;
                var routeFilesPromise = getFilesForRoute(assetPrefix, route).then(function(param) {
                ...
                if (false) {}
                return resolvePromiseWithTimeout(routeFilesPromise, MS_MAX_IDLE_DELAY, markAssetError(new Error("Route did not complete loading: ".concat(route)))).then(function(param) {
...
var Router = /*#__PURE__*/ function() {
   ...
   */ key: "replace",
        ...
        },
        {
            ...
            value: function getRouteInfo(route, pathname, query, as, resolvedAs, routeProps) {
                return _asyncToGenerator(_runtimeJs.default.mark(function _callee() {
                    var _this, existingRouteInfo, cachedRouteInfo, routeInfo, Component, __N_SSG, __N_SSP, __N_RSC, isValidElementType, dataHref, props, _this1, ref, fresh, data;
                    return _runtimeJs.default.wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            case 0:
                                _ctx.prev = 0;
   ...
   */ function prefetch(url, param, param1) {
                ...
                return _asyncToGenerator(_runtimeJs.default.mark(function _callee() {
                    var _this, parsed, pathname, query, parsedAs, localePathResult, pages, resolvedAs, rewrites, ref, rewritesResult, effects, route;
                    return _runtimeJs.default.wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            case 0:
                                _this = this;
