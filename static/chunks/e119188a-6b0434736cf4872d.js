...
/* harmony export */ });
/* harmony import */ var tweetnacl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(780);
...
/* harmony import */ var buffer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9551);
...
/* harmony import */ var bs58__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7191);
...
/* harmony import */ var borsh__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5532);
...
/* harmony import */ var _solana_buffer_layout__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9386);
...
/* harmony import */ var superstruct__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(3471);
/* harmony import */ var rpc_websockets__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3937);
/* harmony import */ var jayson_lib_client_browser__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1198);
...
/* harmony import */ var secp256k1__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7221);
...
/* harmony import */ var js_sha3__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(1094);
...
class PublicKey extends Struct {
  ...
  static async createWithSeed(fromPublicKey, seed, programId) {
    ...
    return new PublicKey(buffer__WEBPACK_IMPORTED_MODULE_1__.Buffer.from(hash, 'hex'));
  }
  /**
...
class Account {
  ...
  constructor(secretKey) {
    ...
    if (secretKey) {
      this._keypair = tweetnacl__WEBPACK_IMPORTED_MODULE_0__.sign.keyPair.fromSecretKey(toBuffer(secretKey));
    } else {
      this._keypair = tweetnacl__WEBPACK_IMPORTED_MODULE_0__.sign.keyPair();
    }
  }
  /**
  ...
  serialize() {
    ...
    const instructions = this.instructions.map(instruction => {
      ...
      return {
        ...
        keyIndices: buffer__WEBPACK_IMPORTED_MODULE_1__.Buffer.from(accounts),
...
class Loader {
  ...
  static async load(connection, payer, program, programId, data) {
    ...
    while (array.length > 0) {
      ...
      const data = buffer__WEBPACK_IMPORTED_MODULE_1__.Buffer.alloc(chunkSize + 16);
      dataLayout.encode({
        instruction: 0,
        // Load instruction
        offset,
...
const BufferFromRawAccountData = (0,superstruct__WEBPACK_IMPORTED_MODULE_10__/* .coerce */ .oQ)((0,superstruct__WEBPACK_IMPORTED_MODULE_10__/* .instance */ .eE)(buffer__WEBPACK_IMPORTED_MODULE_1__.Buffer), RawAccountDataResult, value => buffer__WEBPACK_IMPORTED_MODULE_1__.Buffer.from(value[0], 'base64'));
/**
...
class Keypair {
  ...
  static generate() {
    return new Keypair(tweetnacl__WEBPACK_IMPORTED_MODULE_0__.sign.keyPair());
  }
  /**
  ...
  static fromSecretKey(secretKey, options) {
    const keypair = tweetnacl__WEBPACK_IMPORTED_MODULE_0__.sign.keyPair.fromSecretKey(secretKey);
  ...
  static fromSeed(seed) {
    return new Keypair(tweetnacl__WEBPACK_IMPORTED_MODULE_0__.sign.keyPair.fromSeed(seed));
  }
  /**
...
class Secp256k1Program {
  ...
  static publicKeyToEthAddress(publicKey) {
    ...
    try {
      return buffer__WEBPACK_IMPORTED_MODULE_1__.Buffer.from(js_sha3__WEBPACK_IMPORTED_MODULE_9__.keccak_256.update(toBuffer(publicKey)).digest()).slice(-ETHEREUM_ADDRESS_BYTES);
    } catch (error) {
  ...
  static createInstructionWithPrivateKey(params) {
    ...
    try {
      ...
      const messageHash = buffer__WEBPACK_IMPORTED_MODULE_1__.Buffer.from(js_sha3__WEBPACK_IMPORTED_MODULE_9__.keccak_256.update(toBuffer(message)).digest());
      const {
        signature,
        recid: recoveryId
